...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./CapabilityHandler", "../util/Functions", "./TextInput", "../util/Icons"], factory);
    }
    ...
    var CardButtons = /** @class */ (function (_super) {
        ...
        function CardButtons() {
            ...
            _this.onSubmit = function (newEnergy) { return function (trello) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            parsedEnergy = parseFloat(newEnergy);
                            return [4 /*yield*/, this.cardStorage.setValue("energy", isNaN(parsedEnergy) ? 0 : parsedEnergy)];
                        case 1:
                            _a.sent();
